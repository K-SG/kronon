...
<article>
  <form action="acutualupdate" method="post" class="actual-new-form">
		...
		<div class="actual-regist-area-inner">
		  ...
		  <div class="table-container">
			...
			<table class="actual-table">
			  <tr>
			    <td id="actual-date"><c:out value="${scheduleBean.scheduleDateActual}" />
			      <span id="startTime" class="startTime"><c:out value="${scheduleBean.startTime}" /></span>～
			      <span id="endTime" class="endTime"><c:out value="${scheduleBean.endTime}" /></span>
			    </td>
				<td id="actual-place"></td>
			  </tr>
			  <tr>
				<td class="actual-title" colspan="2"><p><c:out value="${scheduleBean.title}" /></p></td>
			  </tr>
			  <tr>
			    <td class="actual-naiyou" colspan="2"><p><c:out value="${scheduleBean.content}" /></p></td>
			  </tr>
			</table>
		  </div>
		  ...
		  <div class="actual-regist-area-4">
			...
			<div class="actual-regist-content">
			  <textarea name="comment" id="actual-comment" rows="13" cols="40" maxlength="1440" placeholder="予定の内容を1440字以内で入力してください">
			    <c:out value="${scheduleBean.comment}" />
			  </textarea>
			</div>
		  </div>
		</div>
	...
	<div class="cancel-button">
	  <img src="/kronon/img/back_buttom.png" alt="back-buttom" class="back-btn">
	</div>
	    ...
	    <div class="message-container-large">
		  ...
		  <table class="popup-table">
			...
			<tr>
			  ...
			  <td id="time-msg"><c:out value="${scheduleBean.scheduleDateActual}" />
			    <span class="startTime"><c:out value="${scheduleBean.startTime}" /></span>～
			    <span class="endTime"><c:out value="${scheduleBean.endTime}" /></span>
			  </td>
			</tr>
			<tr>
