...
<body>
	...
	<article>
		<form action="acutualupdate" method="post" class="actual-new-form">
			...
			<div class="actual-regist-area">
				<div class="loose-leaf">
					<img src="../img/loose_leaf.svg" alt="loose-leaf" id="loose-leaf">
				</div>
				<div class="actual-regist-area-inner">
					<div class="actual-regist-font-lev0">実績更新</div>
					<input type="hidden" name="scheduleId"
						value="${scheduleBean.scheduleId}" id="set-actual-id">
					<div class="actual-regist-border"></div>
					<div class="table-container">
						<input type="hidden" name="scheduleDate"
							value="${scheduleBean.scheduleDate}" id="set-date"> <input
							type="hidden" value="${scheduleBean.startTime}"
							id="set-start-time"> <input type="hidden"
							value="${scheduleBean.endTime}" id="set-end-time"> <input
							type="hidden" value="${scheduleBean.actualTime}"
							id="set-actual-time"> <input type="hidden"
							value="${scheduleBean.place}" id="set-place"> <input
							type="hidden" value="1" name="actual-flag">
						<table class="actual-table">
							<tr>
								<td id="actual-date"><c:out
										value="${scheduleBean.scheduleDateActual}" /><span
									id="startTime" class="startTime"><c:out
											value="${scheduleBean.startTime}" /></span>～ <span id="endTime"
									class="endTime"><c:out value="${scheduleBean.endTime}" /></span></td>
								<td id="actual-place"></td>
							</tr>
							<tr>
								<td class="actual-title" colspan="2"><p>
										<c:out value="${scheduleBean.title}" />
									</p></td>
							</tr>
							<tr>
								<td class="actual-naiyou" colspan="2"><p>
					...
					<div class="actual-regist-area-1">
						<div class="actual-regist-font-lev1">
							実績時間<span>*</span>
						</div>
					...
					<div class="actual-regist-area-4">
						...
						<div class="actual-regist-content">
							<textarea name="comment" id="actual-comment" rows="13" cols="40"
								maxlength="1440" placeholder="予定の内容を1440字以内で入力してください"><c:out
									value="${scheduleBean.comment}" /></textarea>
						</div>
					</div>
				</div>
				...
				<div class=actual-regist-button>
					...
					<div class=actual-regist-button-right>
						...
						<div class="ok-button large-popup-button cancel-button"
							id="cancel-button">キャンセル</div>
					</div>
				</div>
				<div class="clear"></div>
			</div>
		...
		<div class="cancel-button">
			<img src="/kronon/img/back_buttom.png" alt="back-buttom"
				class="back-btn">
		</div>
		...
		<div class="popup-wrapper error-popup">
			<div class="pop-container">
				<div class="close-popup">
					<img src="/kronon/img/close_button_orange.png" alt="閉じる"
						class="back-button">
				</div>
			...
			<div class="pop-container">
				...
				<div class="pop-container-inner">
					...
					<a href="actualdetail?scheduleId=${scheduleBean.scheduleId}"><div
							class="ok-button">OK</div></a>
					<div class="ng-button close-popup">キャンセル</div>
					<img src="/kronon/img/star/star_angry.png"
						class="pop-img-top star-angry">
				</div>
			</div>
		</div>
		<!--本当に戻りますかポップアップここまで------------------------------------------------------------------->
					...
					<div class="message-container-large">
						...
						<table class="popup-table">
							...
							<tr>
								...
								<td id="time-msg"><c:out
										value="${scheduleBean.scheduleDateActual}" /><span
									class="startTime"><c:out
											value="${scheduleBean.startTime}" /></span>～<span class="endTime"><c:out
											value="${scheduleBean.endTime}" /></span></td>
							</tr>
							<tr>
		...
		<div class="popup-wrapper complete-popup">
			<div class="pop-container">
				...
				<div class="pop-container-inner">
					...
					<img src="/kronon/img/star/star_glass.png"
						class="pop-img-top star-glass">
				</div>
			</div>
		</div>
		<!--登録完了ポップアップここまで-------------------------------------------------------------->
