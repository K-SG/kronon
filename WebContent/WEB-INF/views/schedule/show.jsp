...
<div class="cd-schedule margin-top-lg margin-bottom-lg js-cd-schedule js-schedule-loaded">
...
<ul>
<li class="cd-schedule__event" style="top: 49px; height: 101px">
<a data-start="9:30" data-end="10:30" data-content="event-abs-circuit" data-event="event-1" href="#0">
<em class="cd-schedule__name">Abs Circuit</em>
</a>
</li>
<li class="cd-schedule__event" style="top: 199px; height: 151px">
...
<li class="cd-schedule__event" style="top: 499px; height: 126px">
...
<ul>
<li class="cd-schedule__event" style="top: 99px; height: 101px">
<a data-start="10:00" data-end="11:00" data-content="event-rowing-workout" data-event="event-2" href="#0">
<em class="cd-schedule__name">Rowing Workout</em>
</a>
</li>
<li class="cd-schedule__event" style="top: 249px; height: 151px">
...
<li class="cd-schedule__event" style="top: 449px; height: 151px">
<a data-start="13:30" data-end="15:00" data-content="event-abs-circuit" data-event="event-1" href="#0">
<em class="cd-schedule__name">Abs Circuit</em>
</a>
</li>
<li class="cd-schedule__event" style="top: 674px; height: 101px">
...
<li class="cd-schedule__event" style="top: 649px; height: 101px">
<a data-start="15:30" data-end="16:30" data-content="event-abs-circuit" data-event="event-1" href="#0">
<em class="cd-schedule__name">Abs Circuit</em>
</a>
</li>
<li class="cd-schedule__event" style="top: 799px; height: 151px">
...
<li class="cd-schedule__event" style="top: 349px; height: 151px">
...
<div class="cd-schedule-modal" data-event="event-1">
<header class="cd-schedule-modal__header">
<div class="cd-schedule-modal__content">
<span class="cd-schedule-modal__date">9:30 - 10:30</span>
<h3 class="cd-schedule-modal__name">Abs Circuit</h3>
</div>
